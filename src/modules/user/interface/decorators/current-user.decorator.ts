...
// Shape JwtStrategy.validate attaches to request.user — no DB round-trip. Carries
// the access token's jti + exp so logout can denylist exactly this token. A
// handler needing more (e.g. email) loads it explicitly.
