...
describe('redactPaths', () => {
  // DoD-2: the motivating case. A flat `*.password` wildcard matches only one level deep,
  // so a genuinely nested credential slips through unless the explicit path is listed.
