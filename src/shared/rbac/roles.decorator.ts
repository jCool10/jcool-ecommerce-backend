...
/**
 * Restrict a handler/controller to the listed roles. RolesGuard denies 403 when
 * the authenticated user's role is not among them; a route without `@Roles` only
