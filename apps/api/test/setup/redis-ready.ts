 ...
 * issued before the socket is writable is rejected rather than buffered. That is correct in
 * production, but it makes an early assertion measure the Postgres fall-through, purely on timing.
 */
