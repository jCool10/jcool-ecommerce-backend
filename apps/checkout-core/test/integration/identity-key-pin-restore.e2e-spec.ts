...
import { bucketForEmail, identityKeyFingerprint } from '@jcool/identity';
...
describe('Identity bucket key pin after a partial restore (integration)', () => {
  ...
  // Violated at: src/modules/user/infrastructure/identity-bucket-key.verifier.ts:62-74 — the pin is
