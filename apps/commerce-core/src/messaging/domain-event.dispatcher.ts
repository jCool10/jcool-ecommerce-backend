...
import { UnhandledEventError } from '@shared/messaging/errors';
import type {
  DomainEventDispatcherPort,
  DomainEventHandler,
  EventLabelRegistry,
} from '@shared/messaging/queue/domain-event-dispatcher.port';
...
@Injectable()
export class DomainEventDispatcher implements DomainEventDispatcherPort, EventLabelRegistry {
